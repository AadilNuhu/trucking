            ...
            <div className="mx-auto max-w-7xl">
                ...
                <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    {fleetImages.map((image) => (
                        <div
                            key={image.src}
                            className={`group relative overflow-hidden rounded-2xl ${image.featured ? "sm:col-span-2" : "aspect-[4/5]"
                                }`}
                        >
                            <Image
                                src={image.src}
                                ...
                                width={1536}
                                height={1024}
                                className={`h-full min-h-[320px] w-full object-cover transition-transform duration-700 group-hover:scale-105 ${image.featured ? "sm:min-h-[420px]" : ""
                                    }`}
                            />
